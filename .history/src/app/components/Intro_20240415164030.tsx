...
const Intro = (): React.JSX.Element =>
    <div className="w-screen flex flex-col justify-center items-center bg-white p-10">
        <div className="font-extrabold text-8xl text-black w-100">Firma Andreas Mucha</div>
        <div className="mt-5 w-100">
            <CCarousel controls indicators>
                <CCarouselItem>
                    <CImage className="d-block object-cover" fluid rounded src="/images/bad.jpg" alt="slide 1" />
