...
import badImage from "./../../../public/images/bad.jpg"
...
const Intro = (): React.JSX.Element =>
    <div className="lg:h-screen w-screen h-max section flex justify-center items-center bg-white">
        ...
        <CCarousel controls indicators>
            <CCarouselItem>
                <CImage className="d-block w-100" src={badImage} alt="slide 1" />
            </CCarouselItem>
            <CCarouselItem>
                <CImage className="d-block w-100" src="/public/images/dach.jpg" alt="slide 2" />
            </CCarouselItem>
            <CCarouselItem>
                <CImage className="d-block w-100" src="/public/images/heizung.JPG" alt="slide 3" />
            </CCarouselItem>
        </CCarousel>
    </div>
