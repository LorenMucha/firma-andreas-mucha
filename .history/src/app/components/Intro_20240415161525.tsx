    ...
    <div className="w-screen h-screen bg-white p-10">
        ...
        <div className="mt-5 w-100">
            <CCarousel controls indicators>
                <CCarouselItem>
                    <CImage className="d-block w-100" width={imageWidth} height={imageHeight} src="/images/bad.jpg" alt="slide 1" />
                    <div className="text-black">Bad</div>
                </CCarouselItem>
                <CCarouselItem>
                    <CImage className="d-block w-100" width={imageWidth} height={imageHeight} src="/images/dach.jpg" alt="slide 2" />
                </CCarouselItem>
                <CCarouselItem>
