        ...
        <div className="leistung">
            ...
            <div className="md:flex flex-row mt-4">
                ...
                <div className="md:w-1/6 w-3/4 md:mr-5 md:ml-5 mt-2 mx-auto flex flex-col">
                    <Image alt="image" src={anschlussBild} quality="100" className="pb-2 md:mx-auto" />
                    <Image alt="image" src={rohrBild} quality="100" className="md:mx-auto" />
                </div>
                <div className="md:w-1/6 w-3/4 mt-2 mx-auto flex flex-col">
                    <Image alt="image" src={gestellBild} quality="100" className="object-bottom object-fill" />
                </div>
            </div>
        </div>
    </section>
