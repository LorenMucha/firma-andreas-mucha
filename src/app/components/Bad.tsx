        ...
        <div className="leistung">
            ...
            <div className="md:flex flex-row mt-4">
                <div className="flex-1 md:w-4/6">
                    Wir beraten Sie persönlich direkt vor Ort, um maßgeschneiderte <b>Lösungen für Ihr Bad</b> zu entwickeln.
                    ...
                    <br/><b>In Zusammenarbeit mit zuverlässigen Partnerfirmen</b> realisieren wir Komplettlösungen, von der Planung bis zur Umsetzung.
                    Dazu gehört auch der <b>seniorengerechte Badumbau.</b> Wir unterstützen auch bei der <b>Beantragung von Kassenleistungen</b>.
                ...
                <div className="md:w-1/6 w-3/4 md:mr-5 md:ml-5 mt-2 mx-auto flex flex-col">
                    <Image alt="image" src={badewanne} quality="100" className="pb-2" />
                    <Image alt="image" src={kleinesBad} quality="100" />
                </div>
                <div className="md:w-1/6 w-3/4 mt-2 mx-auto flex flex-col">
                    <Image alt="image" src={waschtisch} quality="100" className="pb-2" />
                    <Image alt="image" src={kloset} quality="100" />
                </div>
